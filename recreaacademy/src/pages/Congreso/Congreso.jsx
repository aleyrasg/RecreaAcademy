    ...
    <Layout>
      ...
      <Box sx={{ flexGrow: 1, p: 4 }}>
        <MotionReveal index={1}>
          <Typography variant="h1" sx={{ fontWeight: "bold", color: "red" }}>
            Congreso
          </Typography>
        </MotionReveal>
        ...
        {/* Carrusel que se refresca animadamente al cambiar el año */}
        <MotionReveal key={selectedYear || "default"} index={4}>
          <Box sx={{ mt: 4 }}>
            <CarruselHorizontal
              onClickVideo={(videoId) =>
                navigate(`/congreso/detalle/${videoId}`)
              }
              videos={selectedYear ? videosPorAno[selectedYear] : youtubeIds}
            />
          </Box>
        </MotionReveal>
              ...
              <Grid item xs={12} md={4}>
                ...
                <Box sx={{ mt: 2 }}>
                  <PonenteCard
                    ...
                    onClick={() =>
                      navigate(
                        `/congreso/detalle/${ponentes[0].nombre
                          .toLowerCase()
                          .replace(/\s+/g, "-")}`
                      )
                    }
